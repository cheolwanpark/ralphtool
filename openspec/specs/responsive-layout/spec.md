...
Provides percentage-based responsive width calculation for TUI layout, ensuring content width adapts to terminal size while maintaining usability and readability through minimum and maximum bounds.
