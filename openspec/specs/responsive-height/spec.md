...
Provides percentage-based responsive height calculation for TUI layout, ensuring content height adapts to terminal size while maintaining usability through minimum and maximum bounds. Mirrors the responsive-width approach for vertical layout.
