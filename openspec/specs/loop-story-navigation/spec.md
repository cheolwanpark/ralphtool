...
Story-based navigation in the loop execution screen. Allows users to navigate between started stories and review past/current work using keyboard controls and visual story indicators.
