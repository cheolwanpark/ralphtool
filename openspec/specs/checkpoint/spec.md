...
Git stash-based state preservation for the Ralph Loop. Provides checkpoint/revert functionality to preserve working directory state before agent execution and restore it on failure.
