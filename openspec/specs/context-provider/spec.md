...
Provides a trait for retrieving unified work context from the spec system. Adapters implement this to assemble all information an agent needs to work on a story.
